...
// 従業員ステータス列挙 / Status enum values
const statusEnum = z.enum(['active', 'inactive'], { message: 'Status must be active or inactive' });

// 過去もしくは今日の日付バリデーション / Validate hire_date is not in the future
...
// 従業員作成スキーマ / Schema for creating an employee
...
// 従業員更新スキーマ / Schema for updating an employee (employee_code is read-only)
...
// 従業員一覧クエリスキーマ / Schema for list query parameters
