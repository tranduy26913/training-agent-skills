// チャチE��コントローラー / Chat controller handling HTTP requests
...
export class ChatController {
  ...
  // セチE��ョン一覧 / GET /workspaces/:id/sessions
  ...
  // セチE��ョン作�E / POST /workspaces/:id/sessions
  ...
  // セチE��ョン取征E/ GET /sessions/:sessionId
  ...
  // セチE��ョン更新 / PATCH /sessions/:sessionId
  async updateSession(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      // [CR-NBLM-LLM-001] llmProviderを含む更新チE�Eタを渡ぁE/ Pass update data including llmProvider
  ...
  // メチE��ージ送信 / POST /sessions/:sessionId/messages
  ...
  // メチE��ージ一覧 / GET /sessions/:sessionId/messages
