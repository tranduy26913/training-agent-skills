// チャチE��ルーター / Chat routes for NotebookLM chat feature
...
// 認証ミドルウェアを�Eルートに適用 / Apply auth middleware to all routes
router.use(authMiddleware);

// セチE��ョン関連ルーチE/ Session routes
router.get(
