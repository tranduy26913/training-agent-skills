...
export default {
  ...
  projects: {
    ...
    form: {
      ...
      promptPlaceholder: 'Nhập system prompt cho AI',
      owner: 'Người tạo',
      createdAt: 'Ngày tạo',
      updatedAt: 'Cập nhật lần cuối',
      createTitle: 'Tạo Project',
      editTitle: 'Chỉnh sửa Project',
    },
    delete: {
      header: 'Xoá Project',
      confirm: 'Bạn có chắc muốn xoá Project {name}?',
    },
    messages: {
      createdSuccess: 'Tạo Project thành công',
      updatedSuccess: 'Cập nhật Project thành công',
      deletedSuccess: 'Xoá Project thành công',
      fetchError: 'Không thể tải danh sách Project',
      notFound: 'Project không tồn tại',
    },
  },
  settings: {
    title: 'Cài đặt',
