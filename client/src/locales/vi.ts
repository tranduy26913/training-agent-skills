...
export default {
  ...
  vocab: {
    ...
    level: 'Cấp độ',
    status: 'Trạng thái',
    imageUrl: 'Ảnh minh hậa',
    imageUrlPlaceholder: 'Nhập URL hình ảnh',
    note: 'Ghi chú',
    notePlaceholder: 'Nhập ghi chú',
    tags: 'Tags',
    tagsPlaceholder: 'Nhập tag, nhấn Enter',
    related: 'Từ liên quan',
    relatedPlaceholder: 'Chọn từ liên quan',
    synonyms: 'Đồng nghĩa',
    synonymPlaceholder: 'Chọn từ đồng nghĩa',
    antonyms: 'Trái nghĩa',
    antonymPlaceholder: 'Chọn từ trái nghĩa',
    // audit tab
    createdBy: 'Tạo bởi',
