...
export default {
  ...
  projects: {
    ...
    form: {
      ...
      projectPrompt: 'プロンプト',
      promptPlaceholder: 'AI用のシステムプロンプトを入力',
      owner: '作成者',
      createdAt: '作成日',
      updatedAt: '最終更新',
    ...
    delete: {
      header: 'プロジェクト削除',
      confirm: 'プロジェクト {name} を削除してもよろしいですか？',
    },
    messages: {
      createdSuccess: 'プロジェクトを作成しました',
      updatedSuccess: 'プロジェクトを更新しました',
      deletedSuccess: 'プロジェクトを削除しました',
      fetchError: 'プロジェクトの読み込みに失敗しました',
