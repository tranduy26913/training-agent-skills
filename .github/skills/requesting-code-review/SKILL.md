...
Load `requesting-code-review/review-rules.md`.
...
See rules at: requesting-code-review/review-rules.md  
See reviewer template at: requesting-code-review/code-reviewer.md
