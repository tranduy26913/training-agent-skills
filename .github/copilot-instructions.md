...
**Always present next-step suggestions as a short list of selectable options using #tool:vscode/askQuestions**.
...
- Wait for the user's choice, then continue handling that specific selection.- Always set allowFreeformInput: true. Do not omit this in any #tool:vscode/askQuestions call.
